        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse show" id="navbarColor02" style="">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('formularioCliente') }}">Registrar un cliente</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('formularioEmpleado') }}">Registrar un empleado</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('formMantenimiento') }}">Formulario de mantenimiento</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('formularioTarea') }}">Insertar una tarea / incidencia</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('listaTareas') }}">Lista de tareas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('listaEmpleados') }}">Lista de empleados</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('formMantenimiento') }}">Formulario de
                                mantenimiento</a>
